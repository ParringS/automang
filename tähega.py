#see versioon oli kasutuses, et tähe osa välja töötada, päris programm on "PROJEKT 1.0"
...
#auto = pygame.image.load('auto_lihtne2.png') # mõõtmed 136x190
